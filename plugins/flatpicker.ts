      ...
      ".flatpickr-month": {
        ...
        ".flatpickr-current-month": {
          ...
          ".flatpickr-monthDropdown-months": {
            ...
            "@apply bg-transparent dark:bg-zink-600 text-zink-500 dark:text-zink-50": {}
          },
        }
      },
    ...
    ".numInputWrapper": {
      ...
      span: {
        "&.arrowUp::before,  &.arrowUp::after": {
          "@apply border-b-zink-500 dark:border-b-zink-50": {}
        },
  
        "&.arrowDown::before,  &.arrowDown::after": {
          "@apply border-t-zink-500 dark:border-t-zink-50": {}
        }
      }
    },
