...
const getBorderClass = computed(() => {
  ...
  if (border) {
    if (valid) {
      return "border-green-500 dark:border-green-800 dark:bg-zink-700";
    } else if (invalid) {
      return "border border-red-500 dark:border-red-800 dark:bg-zink-700";
    }
    return "border-slate-200 dark:border-zink-500 disabled:border-slate-300 focus:border-custom-500 dark:disabled:border-zink-500 dark:focus:border-custom-800 dark:bg-zink-700";
  }
  ...
  <div :class="!hideDetails ? 'mb-4' : ''">
    ...
    <div class="relative">
      ...
      <input
        v-model="value"
        :type="type"
        class="form-input focus:outline-none disabled:bg-slate-100 dark:disabled:bg-zink-600 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 placeholder:text-slate-400 dark:placeholder:text-zink-200 dark:autofill:shadow-[inset_0_0_0px_1000px_rgb(146,175,211)]"
